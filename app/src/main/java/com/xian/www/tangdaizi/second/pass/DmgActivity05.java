...
public class DmgActivity05 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dmg_pass_05);
    ...
    public void radio01() {
        ...
        SPUtil.appput(getApplicationContext(), "dmg_test_five", "wrong");
        radio01.setImageResource(R.drawable.radio_wrong);
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
               startActivity(new Intent(DmgActivity05.this,DmgActivity06.class));
    ...
    public void radio02() {
        ...
        radio02.setClickable(false);
        radio03.setClickable(false);
        SPUtil.appput(getApplicationContext(), "dmg_test_five", "right");
