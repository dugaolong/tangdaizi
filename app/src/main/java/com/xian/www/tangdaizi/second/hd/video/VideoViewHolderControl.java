...
import com.xian.www.tangdaizi.second.hd.tools.Constants;
...
//        mUrl = "http://img.owspace.com/V_tnh2100_1453346133.2098116.m3u8";
	...
	public void setIsFullScreenMode(boolean isFullMode){
		...
		if(mIsFullScreenMode){
			if(mHolder != null){
				mHolder.halfFullIb.setImageResource(R.drawable.library_video_mediacontroller_to_half);
	...
	private void setHalfFullScreenState(VideoViewHolder holder, boolean isFull){
		if(isFull){
			holder.halfFullIb.setImageResource(R.drawable.library_video_mediacontroller_to_half);
		}else{
			holder.halfFullIb.setImageResource(R.drawable.library_video_mediacontroller_to_full);
		}
	}
	...
	private void showPlayingState(VideoViewHolder holder){
		...
		holder.playPauseIb.setImageResource(R.drawable.library_video_mediacontroller_pause);
	...
	private void showPauseState(VideoViewHolder holder){
		...
		holder.playPauseIb.setImageResource(R.drawable.library_video_mediacontroller_play);
