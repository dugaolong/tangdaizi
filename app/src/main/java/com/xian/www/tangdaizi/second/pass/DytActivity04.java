...
public class DytActivity04 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dyt_pass_04);
    ...
    public void radio01() {
        ...
        SPUtil.appput(getApplicationContext(), "dyt_test_four", "right");
    ...
    public void radio02() {
        ...
        radio02.setClickable(false);
        radio03.setClickable(false);
        SPUtil.appput(getApplicationContext(), "dyt_test_four", "wrong");
