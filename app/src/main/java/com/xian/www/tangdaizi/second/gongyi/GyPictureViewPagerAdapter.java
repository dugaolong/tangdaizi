...
//		this.list = mlist;
		...
		list.add(R.drawable.gy_one);
		list.add(R.drawable.gy_two);
		list.add(R.drawable.gy_three);
		list.add(R.drawable.gy_four);
		list.add(R.drawable.gy_five);
		list.add(R.drawable.gy_six);
		list.add(R.drawable.gy_seven);
		list.add(R.drawable.gy_eight);
		list.add(R.drawable.gy_nine);
		list.add(R.drawable.gy_ten);
		list.add(R.drawable.gy_eleven);
		list.add(R.drawable.gy_twelve);
	}
