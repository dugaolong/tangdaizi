...
public class DmgActivity01 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dmg_pass_01);
    ...
    public void radio01() {
        ...
        SPUtil.appput(getApplicationContext(), "dmg_test_one", "right");
        radio01.setImageResource(R.drawable.radio_right);
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
               startActivity(new Intent(DmgActivity01.this,DmgActivity02.class));
    ...
    public void radio02() {
        ...
        radio02.setClickable(false);
        radio03.setClickable(false);
        SPUtil.appput(getApplicationContext(), "dmg_test_one", "wrong");
