...
public class DytActivity02 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dyt_pass_02);
    ...
    public void radio01() {
        ...
        SPUtil.appput(getApplicationContext(), "dyt_test_two", "wrong");
        radio01.setImageResource(R.drawable.radio_wrong);
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
               startActivity(new Intent(DytActivity02.this,DytActivity03.class));
    ...
    public void radio02() {
        radio01.setClickable(false);
        radio02.setClickable(false);
        SPUtil.appput(getApplicationContext(), "dyt_test_two", "right");
