...
public class DatangActivity01 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.datang_pass_01);
    ...
    public void radio01() {
        ...
        SPUtil.appput(getApplicationContext(), "datang_test_one", "wrong");
        radio01.setImageResource(R.drawable.radio_wrong);
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
               startActivity(new Intent(DatangActivity01.this,DatangActivity02.class));
    ...
    public void radio02() {
        ...
        radio02.setClickable(false);
        radio03.setClickable(false);
        SPUtil.appput(getApplicationContext(), "datang_test_one", "right");
