...
public class DtdaoyouActivity extends Activity implements SeekBar.OnSeekBarChangeListener {
            ...
            switch (v.getId()) {
                case R.id.playButton:
                    if (m.isPlaying()) {
                        ...
                        m.reset();//恢复到未初始化的状态
                        m = MediaPlayer.create(DtdaoyouActivity.this, R.raw.a_dt);//读取音频
                    ...
                    thread = new Thread(new DtdaoyouActivity.SeekBarThread());
                    // 启动线程
                    thread.start();
                    break;
...
//        now_time = (TextView) findViewById(R.id.now_time);
        ...
        playButton.setOnClickListener(new DtdaoyouActivity.ClickEvent());
        stopButton.setOnClickListener(new DtdaoyouActivity.ClickEvent());
