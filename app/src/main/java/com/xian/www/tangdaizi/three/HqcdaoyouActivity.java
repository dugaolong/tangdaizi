...
public class HqcdaoyouActivity extends Activity implements SeekBar.OnSeekBarChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnPlayUrl.setOnClickListener(new HqcdaoyouActivity.VideoClickEvent());

        btnPause = (Button) this.findViewById(R.id.btnPause);
        btnPause.setOnClickListener(new HqcdaoyouActivity.VideoClickEvent());
        MediaMetadataRetriever rev = new MediaMetadataRetriever();

        rev.setDataSource(this, Uri.parse("android.resource://" + getPackageName() + "/" + R.raw.r_hqc)); //这里第一个参数需要Context，传this指针
            ...
            switch (v.getId()) {
                case R.id.playButton:
                    if (m.isPlaying()) {
                        ...
                        m.reset();//恢复到未初始化的状态
                        m = MediaPlayer.create(HqcdaoyouActivity.this, R.raw.a_dyt);//读取音频
                    ...
                    thread = new Thread(new HqcdaoyouActivity.SeekBarThread());
                    // 启动线程
                    thread.start();
                    break;
...
//        now_time = (TextView) findViewById(R.id.now_time);
        ...
        playButton.setOnClickListener(new HqcdaoyouActivity.ClickEvent());
        stopButton.setOnClickListener(new HqcdaoyouActivity.ClickEvent());
    ...
    class VideoClickEvent implements View.OnClickListener {
        ...
        public void onClick(View arg0) {
            if (arg0 == btnPause) {
                ...
                //设置播放加载路径
                videoview.setVideoURI(Uri.parse("android.resource://" + getPackageName() + "/" + R.raw.r_hqc));
                //播放
                videoview.start();
                //循环播放
