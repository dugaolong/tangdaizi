...
public class DmgActivity03 extends Activity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dmg_pass_03);
    ...
    public void radio02() {
        ...
        String dmg_test_one = appget(getApplicationContext(), "dmg_test_one", "wrong");
    ...
    private void showPupop(final boolean tag) {
        ...
        if(tag){
            contentView  = LayoutInflater.from(DmgActivity03.this).inflate(R.layout.popuplayout_half, null);
            queding = (ImageView) contentView.findViewById(R.id.queding);
            queding.setOnClickListener(this);
        }else {
            contentView  = LayoutInflater.from(DmgActivity03.this).inflate(R.layout.popuplayout_failed, null);
