...
public class ZsjsHighActivity04 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.zsjs_high_04);
...
//            super.handleMessage(msg);
    ...
    public void radio01() {
        ...
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
                startActivity(new Intent(ZsjsHighActivity04.this,ZsjsHighActivity05.class));
