...
public class DatangActivity02 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(cn.dq.www.guangchangan.R.layout.datang_pass_02);
    ...
    public void radio01() {
        ...
        SPUtil.appput(getApplicationContext(), "datang_test_two", "wrong");
        radio01.setImageResource(cn.dq.www.guangchangan.R.drawable.radio_wrong);
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
               startActivity(new Intent(DatangActivity02.this,DatangActivity03.class));
 ...
 @OnClick(cn.dq.www.guangchangan.R.id.radio03)   //
    public void radio03() {
        ...
        radio02.setClickable(false);
        radio03.setClickable(false);
        SPUtil.appput(getApplicationContext(), "datang_test_two", "right");
