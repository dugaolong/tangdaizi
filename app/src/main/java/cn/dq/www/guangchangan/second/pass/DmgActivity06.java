...
public class DmgActivity06 extends Activity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(cn.dq.www.guangchangan.R.layout.dmg_pass_06);

        //using butter knife
        ButterKnife.inject(this);
        handler = new Handler();
        complete = SPUtil.appget(this, "liang12", "no");
    }
    ...
    public void radio02() {
        ...
        String dmg_test_four = SPUtil.appget(getApplicationContext(), "dmg_test_four", "wrong");
    ...
    private void showPupop(final boolean tag) {
        ...
        if(tag){
            if(complete.equals("no")){
                contentView  = LayoutInflater.from(DmgActivity06.this).inflate(cn.dq.www.guangchangan.R.layout.popuplayout, null);
                queding = (ImageView) contentView.findViewById(cn.dq.www.guangchangan.R.id.queding);
                queding.setOnClickListener(this);
            }else {
                contentView  = LayoutInflater.from(DmgActivity06.this).inflate(cn.dq.www.guangchangan.R.layout.popuplayout_half, null);
                queding = (ImageView) contentView.findViewById(cn.dq.www.guangchangan.R.id.queding);
                queding.setOnClickListener(this);
            }
        }else {
            contentView  = LayoutInflater.from(DmgActivity06.this).inflate(cn.dq.www.guangchangan.R.layout.popuplayout_failed, null);
