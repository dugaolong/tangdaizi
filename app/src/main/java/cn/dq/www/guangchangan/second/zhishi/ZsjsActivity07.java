...
public class ZsjsActivity07 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(cn.dq.www.guangchangan.R.layout.zsjs_07);
...
//        radio01.setImageResource(R.drawable.radio_right);
        ...
        Toast.makeText(ZsjsActivity07.this,"再想一想",Toast.LENGTH_LONG).show();
...
//        radio02.setImageResource(R.drawable.radio_wrong);
        ...
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
                startActivity(new Intent(ZsjsActivity07.this,ZsjsActivity08.class));
