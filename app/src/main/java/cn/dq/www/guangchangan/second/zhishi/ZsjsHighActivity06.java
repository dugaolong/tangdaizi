...
public class ZsjsHighActivity06 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(cn.dq.www.guangchangan.R.layout.zsjs_high_06);
...
//            super.handleMessage(msg);
    ...
    public void radio01() {
        ...
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
                startActivity(new Intent(ZsjsHighActivity06.this,ZsjsHighActivity07.class));
