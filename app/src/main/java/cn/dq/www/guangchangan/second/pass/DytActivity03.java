...
public class DytActivity03 extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(cn.dq.www.guangchangan.R.layout.dyt_pass_03);
    ...
    public void radio02() {
        radio01.setClickable(false);
        radio02.setClickable(false);
        String dyt_test_one = SPUtil.appget(getApplicationContext(), "dyt_test_one", "wrong");
    ...
    private void showPupop(final boolean tag) {
        ...
        if(tag){
            contentView  = LayoutInflater.from(DytActivity03.this).inflate(cn.dq.www.guangchangan.R.layout.popuplayout_half, null);
            queding = (ImageView) contentView.findViewById(cn.dq.www.guangchangan.R.id.queding);
            queding.setOnClickListener(this);
        }else {
            contentView  = LayoutInflater.from(DytActivity03.this).inflate(cn.dq.www.guangchangan.R.layout.popuplayout_failed, null);
