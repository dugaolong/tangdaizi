...
public class ZsjsActivity03 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.zsjs_03);
...
//        radio01.setImageResource(R.drawable.radio_wrong);
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
                startActivity(new Intent(ZsjsActivity03.this,ZsjsActivity04.class));
...
//        radio02.setImageResource(R.drawable.radio_right);
        Toast.makeText(ZsjsActivity03.this,"再想一想",Toast.LENGTH_LONG).show();
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
