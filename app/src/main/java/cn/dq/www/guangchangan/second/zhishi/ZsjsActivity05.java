...
public class ZsjsActivity05 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(cn.dq.www.guangchangan.R.layout.zsjs_05);
...
//        radio01.setImageResource(R.drawable.radio_right);
        ...
        Toast.makeText(ZsjsActivity05.this,"再想一想",Toast.LENGTH_LONG).show();
...
//        radio02.setImageResource(R.drawable.radio_wrong);
        ...
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
                startActivity(new Intent(ZsjsActivity05.this,ZsjsActivity06.class));
