...
public class ZsjsHighActivity05 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.zsjs_high_05);
...
//            super.handleMessage(msg);
    ...
    public void radio04() {
        ...
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
                startActivity(new Intent(ZsjsHighActivity05.this,ZsjsHighActivity06.class));
