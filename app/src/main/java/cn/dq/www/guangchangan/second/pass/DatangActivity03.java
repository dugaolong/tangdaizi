...
public class DatangActivity03 extends Activity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.datang_pass_03);
    ...
    public void radio01() {
        ...
        String datang_test_one = SPUtil.appget(getApplicationContext(), "datang_test_one", "wrong");
        String datang_test_two = SPUtil.appget(getApplicationContext(), "datang_test_two", "wrong");
        radio01.setImageResource(R.drawable.radio_right);
        if(datang_test_one.equals("right")&&datang_test_two.equals("right"))
            showPupop(true);
        else
            showPupop(false);
    }
    ...
    private void showPupop(final boolean tag) {
        ...
        if(tag){
            ...
            contentView  = LayoutInflater.from(DatangActivity03.this).inflate(R.layout.popuplayout_failed, null);
