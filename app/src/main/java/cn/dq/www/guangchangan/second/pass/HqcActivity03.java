...
public class HqcActivity03 extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.hqc_pass_03);
    ...
    public void radio01() {
        ...
        String hqc_test_one = SPUtil.appget(getApplicationContext(), "hqc_test_one", "wrong");
        String hqc_test_two = SPUtil.appget(getApplicationContext(), "hqc_test_two", "wrong");
        radio01.setImageResource(R.drawable.radio_right);
        if(hqc_test_one.equals("right")&&hqc_test_two.equals("right"))
            showPupop(true);
        else
            showPupop(false);
    }
    ...
    private void showPupop(final boolean tag) {
        ...
        if(tag){
            contentView  = LayoutInflater.from(HqcActivity03.this).inflate(R.layout.popuplayout_half, null);
            queding = (ImageView) contentView.findViewById(R.id.queding);
            queding.setOnClickListener(this);
        }else {
            contentView  = LayoutInflater.from(HqcActivity03.this).inflate(R.layout.popuplayout_failed, null);
