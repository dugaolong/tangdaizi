...
public class ZsjsActivity02 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(cn.dq.www.guangchangan.R.layout.zsjs_02);
...
//        radio01.setImageResource(R.drawable.radio_wrong);
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
                startActivity(new Intent(ZsjsActivity02.this, ZsjsActivity03.class));
...
//        radio02.setImageResource(R.drawable.radio_right);
        Toast.makeText(ZsjsActivity02.this,"再想一想",Toast.LENGTH_LONG).show();
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
