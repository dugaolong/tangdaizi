...
//	private TextView nameDt;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(cn.dq.www.guangchangan.R.layout.gy_picture_details_activity);
	...
	private void initView() {
		...
		back = (ImageView) findViewById(cn.dq.www.guangchangan.R.id.details_btn_back);

		back.setOnClickListener(this);

		titleLayout = (RelativeLayout) findViewById(cn.dq.www.guangchangan.R.id.details_title_layout);
		contentLayout = (RelativeLayout) findViewById(cn.dq.www.guangchangan.R.id.details_content_layout);
		content = (TextView) findViewById(cn.dq.www.guangchangan.R.id.details_content);
		content.setMovementMethod(ScrollingMovementMethod.getInstance());

		viewpager = (ViewPager) findViewById(cn.dq.www.guangchangan.R.id.details_viewpager);
	...
	public void onClick(View v) {
		if(v.getId() == cn.dq.www.guangchangan.R.id.details_btn_back){
			if(isDelete) {
				setResult(RESULT_OK);
			}
			finish();
