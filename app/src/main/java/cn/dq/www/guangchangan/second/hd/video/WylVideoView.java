...
//		mIsFullScreen = isFull;
    ...
    private void initAttrs(Context context, AttributeSet attrs){
    	TypedArray ta = context.obtainStyledAttributes(attrs, cn.dq.www.guangchangan.R.styleable.CustomVideoView);
    	mIsFullScreen = ta.getBoolean(cn.dq.www.guangchangan.R.styleable.CustomVideoView_fullScreen, false);
    	ta.recycle();
    }
