...
public class DatangActivity06 extends Activity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(cn.dq.www.guangchangan.R.layout.datang_pass_06);

        //using butter knife
        ButterKnife.inject(this);
        complete = SPUtil.appget(this, "liang9", "no");
        handler = new Handler();
    }
    ...
    public void radio01() {
        ...
        String datang_test_four = SPUtil.appget(getApplicationContext(), "datang_test_four", "wrong");
        String datang_test_five = SPUtil.appget(getApplicationContext(), "datang_test_five", "wrong");
        radio01.setImageResource(cn.dq.www.guangchangan.R.drawable.radio_right);
        if(datang_test_four.equals("right")&&datang_test_five.equals("right"))
            showPupop(true);
        else
            showPupop(false);
    }
    ...
    private void showPupop(final boolean tag) {
        ...
        if(tag){
            if(complete.equals("no")){
                contentView  = LayoutInflater.from(DatangActivity06.this).inflate(cn.dq.www.guangchangan.R.layout.popuplayout, null);
                queding = (ImageView) contentView.findViewById(cn.dq.www.guangchangan.R.id.queding);
                queding.setOnClickListener(this);
            }else {
                contentView  = LayoutInflater.from(DatangActivity06.this).inflate(cn.dq.www.guangchangan.R.layout.popuplayout_half, null);
                queding = (ImageView) contentView.findViewById(cn.dq.www.guangchangan.R.id.queding);
                queding.setOnClickListener(this);
            }

        }else {
            contentView  = LayoutInflater.from(DatangActivity06.this).inflate(cn.dq.www.guangchangan.R.layout.popuplayout_failed, null);
    ...
    private void closePupop(boolean tag) {
        if(tag){
            popWnd.dismiss();
            SPUtil.appput(getApplicationContext(), "liang9", "yes");
            finish();
        }else {
            popWnd.dismiss();
            finish();
