...
public class DmgActivity02 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dmg_pass_02);
    ...
    public void radio01() {
        ...
        SPUtil.appput(getApplicationContext(), "dmg_test_two", "wrong");
        radio01.setImageResource(R.drawable.radio_wrong);
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
               startActivity(new Intent(DmgActivity02.this,DmgActivity03.class));
    ...
    public void radio02() {
        ...
        radio02.setClickable(false);
        radio03.setClickable(false);
        SPUtil.appput(getApplicationContext(), "dmg_test_two", "right");
