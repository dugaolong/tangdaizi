...
public class ZsjsHighActivity01 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(cn.dq.www.guangchangan.R.layout.zsjs_high_01);
...
//            super.handleMessage(msg);
    ...
    public void radio02() {
        ...
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
                startActivity(new Intent(ZsjsHighActivity01.this,ZsjsHighActivity02.class));
