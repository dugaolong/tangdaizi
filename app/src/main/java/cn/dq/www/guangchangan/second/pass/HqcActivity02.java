...
public class HqcActivity02 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(cn.dq.www.guangchangan.R.layout.hqc_pass_02);
    ...
    public void radio01() {
        ...
        SPUtil.appput(getApplicationContext(), "hqc_test_two", "wrong");
        radio01.setImageResource(cn.dq.www.guangchangan.R.drawable.radio_wrong);
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
                startActivity(new Intent(HqcActivity02.this,HqcActivity03.class));
    ...
    public void radio02() {
        ...
        radio02.setClickable(false);
        radio03.setClickable(false);
        SPUtil.appput(getApplicationContext(), "hqc_test_two", "right");
